package exemplo_2.cenarios;

// Módulo 04 / Capítulo 15 / aulas 05 e 06 - Interfaces
// Exemplo 2: Solução com interface, inversão de controle e injeção de dependência

import exemplo_2.modelos.entidades.Locacao;
import exemplo_2.modelos.entidades.Veiculo;
import exemplo_2.modelos.servicos.ImpostoBrasil;
import exemplo_2.modelos.servicos.ServicoLocacao;
...
public class Main
{
   public static void main(String[] args) throws ParseException
   {
      ...
      // Injeção de dependência por meio do construtor - "new ImpostoBrasil()"
      // O construtor pode receber qualquer classe que implemente a interface "Imposto".
